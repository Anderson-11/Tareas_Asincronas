...
#Definir que etapa esta viviendo el usuario  
...
#Definir si la edad ingresada es par o impar.
if edad%2==0:
    print()
    print(f"La edad ingresada de {nombre} es par")
    
else:
    print()
    print(f"La edad ingresada de {nombre} es impar")
