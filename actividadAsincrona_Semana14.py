...
#Imprime los departamentos
     for i in depa:
            print(f"✓ {i}")
     print()
     menu=input("\nIngresa un departamento-> ").lower()
        
     while menu!="ahuachapan" and menu!="cabañas" and menu!="chalatenango" and menu!="cuscatlan" and menu!="la liberta" and menu!="la paz" and menu!="la union" and menu!="morazan" and menu!="san miguel" and menu!="san salvador" and menu!="santa ana" and menu!="sonsonate" and menu!="san vicente" and menu!="usulutan":

      print("[-] Error, Ingresa un departamento compatible")
      print()
      menu=input("\nIngresa un departamento de los que se encuentran en pantalla-> ").lower()

#Esta funcion valida el departamento ingresado
     if menu == "ahuachapan":
         for i in array1:
              print(f"Los municipios de Ahuchapan son: {i}")
     elif menu == "cabañas":
          for i in array2:
              print(f"Los municipios de Cabañas son: {i}")
     elif menu == "chalatenango":
          for i in array3:
              print(f"Los municipios de Chalatenango son: {i}")
     elif menu == "cuscatlan":
          for i in array4:
              print(f"Los municipios de Cuscatlan son: {i}")
     elif menu == "la libertad":
          for i in array5:
              print(f"Los municipios de La Libertad son: {i}")
     elif menu == "la paz":
          for i in array6:
              print(f"Los municipios de La Paz son: {i}")
     elif menu == "la union":
          for i in array7:
              print(f"Los municipios de La Union son: {i}")
     elif menu == "morazan":
          for i in array8:
              print(f"Los municipios de Morazan son: {i}")
     elif menu == "san miguel":
          for i in array9:
              print(f"Los municipios de San Miguel son: {i}")
     elif menu == "san salvador":
          for i in array10:
              print(f"Los municipios San Salvador son: {i}")
     elif menu == "santa ana":
         for i in array11:
              print(f"Los municipios de Santa Ana son: {i}")
     elif menu == "sonsonate":
          for i in array12:
              print(f"Los municipios de Sonsonate son: {i}")
     elif menu == "san vicente":
          for i in array13:
              print(f"Los municipios de San Vicente son: {i}")
     elif menu == "usulutan":
          for i in array14:
              print(f"Los municipios de Usulutan son: {i}")

#Esta funcion es por si deseas consultar otro departamento o finalizarlo
     Preguntar= input("\nDigita ¨1¨ para consultar otro departamento o ¨2¨ para finalizar: ")
     while Preguntar!="1" and Preguntar!="2":

      print("Error ingresa ¨1¨ o ¨2¨")
      Preguntar= input("\nIngresa ¨1¨ si desea ejecutar el programa o ¨2¨ si deseas finalizar: ").lower()
     if Preguntar=="1":
      ejecutar_pogra()
     else : 
...
Contenedor= input("\nIngresa ¨SI¨ si desea ejecutar el programa o ¨NO¨ si deseas salir: ").lower()
